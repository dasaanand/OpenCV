...
int main( int argc, char** argv )
{
	...
	char CASCADE_NAME[2][CASCADE_NAME_LEN] = {"smiled_05.xml", "haarcascade_frontalface_alt.xml"} ;
	
	CFBundleRef mainBundle  = CFBundleGetMainBundle ();
    assert (mainBundle);
	CFURLRef    cascade_url[2];
	cascade_url[0] = CFBundleCopyResourceURL (mainBundle, CFSTR("smiled_05"), CFSTR("xml"), NULL);
    cascade_url[1] = CFBundleCopyResourceURL (mainBundle, CFSTR("haarcascade_frontalface_alt"), CFSTR("xml"), NULL);
    ...
    fcascade = (CvHaarClassifierCascade*)cvLoad(CASCADE_NAME[0], 0, 0, 0 );
    cascade = (CvHaarClassifierCascade*)cvLoad(CASCADE_NAME[1], 0, 0, 0 );
